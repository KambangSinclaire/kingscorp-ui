<template>
  <div class="toast" v-if="!this.toast">
    ...
    <div v-if="false" id="toast-interactive" class="w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-400" role="alert">
        <div class="flex">
    ...
    <!-- chat message -->     
    <div v-if="false" id="toast-notification" class="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300" role="alert">
    ...
    <!-- bottom notification -->
    <div v-if="false" id="toast-undo" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <!-- alerts -->
    <!-- success  -->
    <div v-if="false" id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <!-- delete -->
    <div v-if="this.data?.status >= 400" id="toast-danger" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <!-- warning -->
    <div v-if="false" id="toast-warning" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
@Options({
  ...
  computed: {
    recieveData() {
        let { status, message, type } = this.toast

        let data:ToastInterface = {
            status:status,
            message:message,
            type:type
        } 
        this.data = data
        console.log(this.toast, "this is the toast");
        return this.data
    },
  },
})
