<template>
  <div class="toast" >
    ...
    <!-- success  -->
        ...
        <!-- delete -->
        <div v-if="this.toast?.type === 'DELETE'" id="toast-danger" class="flex items-center w-full p-4 mb-4 text-white bg-red-700 rounded shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
