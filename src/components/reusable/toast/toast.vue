<template>
  <div class="toast" >
    ...
    <!-- alerts -->
    <!-- success  -->
        <div v-if="this.toast?.type === 'SUCCESS'" id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <!-- delete -->
        <div v-if="this.toast?.type === 'DELETE'" id="toast-danger" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <!-- warning -->
        <div v-if="this.toast?.type === 'WARNING'" id="toast-warning" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
